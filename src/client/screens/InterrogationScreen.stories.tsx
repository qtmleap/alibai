...
/**
 * 初手。一往復だけ交わし、表には裏付けの取れた線が一本だけ立っている。
 *
 * 白紙に近い盤面がどう見えるかを押さえる story——線が一本しか無いあいだの
 * 目盛りの間合いと、まだ食い違いの架かっていない列のあいだを確かめる。
 */
export const FirstTurn: Story = {
  // 既定では書き出し名を単語に割って「First Turn」になる。突き合わせの対応表が
...
/**
 * 食い違いが立つところ。九手目で瀬名が「あの戸は一度も開かなかった」と言い、
 * 牧野の申告と噛み合わなくなる。
 *
 * 表の上では、噛み合わない二人の列のあいだへ十八時三十六分の高さで線が一本架かり、
 * 両端に目盛りが立つ。盤面にひとつだけの印なので、ここが立っているかどうかで
 * 突き合わせの成否が決まる。
 */
